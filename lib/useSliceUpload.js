...
const useSliceUpload = (options = {}) => {
    ...
    const createFileHash = (file, chunks) => __awaiter(void 0, void 0, void 0, function* () {
        return new Promise((resolve, reject) => {
            ...
            (0, utils_1.invokeHooks)(beforeFileHash, utils_1.Hooks.BEFORE_FILE_HASH, file, chunks);
...
exports.useSliceUpload = useSliceUpload;
